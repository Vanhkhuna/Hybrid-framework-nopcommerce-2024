...
public class GossByTestcase extends BaseTest {
    ...
    public void beforeClass(String browserName) {
        ...
        driver.get("https://rebuild.9prints.com/en-us/product/66456C0CB69B6FN/vanh-auto-test-please-ko-chinh-sua?sref=19&variant=1641925");
        //----->run all TC 1-> 5
    ...
    public void TC_01_Product_Detail() {
        ...
        //String priceGiftProductPage = productPage.getPriceGift();
    ...
    public void TC_02_Shopping_Cart() {
        ...
        //Assert.assertEquals(shoppingCartPage.getPriceGift(), priceGiftProductPage);
        ...
        LogHelper.info("Shopping Cart Page -Step 10 : Click to Save button");
        ...
        LogHelper.info("Shopping Cart Page -Step 11 : Click to country dropdown");
        shoppingCartPage.clickToCountryDropdown();

        LogHelper.info("Shopping Cart Page -Step 12 : Click to country");
        shoppingCartPage.clickToCountry(driver, country);

        LogHelper.info("Shopping Cart Page -Step 13 : Click to Save button");
        shoppingCartPage.clickToSaveButton();

        LogHelper.info("Shopping Cart Page -Step 14 : Verify Image Cart Loading Invisible");
        Assert.assertTrue(shoppingCartPage.waitForImageCartLoadingInvisible());

        LogHelper.info("Shopping Cart Page -Step 15 : Verify Country after changing displayed correctly");
        Assert.assertEquals(shoppingCartPage.isCountryChangedDisplayed(), "Shipping to: " + country);

        LogHelper.info("Shopping Cart Page -Step 16 : Enter discount code not exist");
        shoppingCartPage.inputDiscountCodeToTextbox("AUTOTEST8");

        LogHelper.info("Shopping Cart Page -Step 17 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 18 : Verify error message displayed");
        Assert.assertEquals(shoppingCartPage.getErrorMessageDisplayed(), "Your order hasn't met the code requirements");

        LogHelper.info("Shopping Cart Page -Step 19 : Click to Plus button");
        shoppingCartPage.clickToPlusButton();

        LogHelper.info("Shopping Cart Page -Step 20 : Verify product updated message displayed");
        Assert.assertEquals(shoppingCartPage.getProductUpdateMessageDisplayed(), "The total amount has been updated.");

        LogHelper.info("Shopping Cart Page -Step 21 : Verify Subtotal correctly");
        Assert.assertEquals(shoppingCartPage.isPriceActualUIDisplayed(), shoppingCartPage.isTotalExpectedDisplayed());

        LogHelper.info("Shopping Cart Page -Step 22 : Click to Plus button");
        shoppingCartPage.clickToPlusButton();

        LogHelper.info("Shopping Cart Page -Step 23 : Verify product updated message displayed");
        Assert.assertEquals(shoppingCartPage.getProductUpdateMessageDisplayed(), "The total amount has been updated.");

        LogHelper.info("Shopping Cart Page -Step 24 : Verify Subtotal correctly");
        Assert.assertEquals(shoppingCartPage.isPriceActualUIDisplayed(), shoppingCartPage.isTotalExpectedDisplayed());

        LogHelper.info("Shopping Cart Page -Step 25 : Click to Minus button");
        shoppingCartPage.clickToPlusButton();

        LogHelper.info("Shopping Cart Page -Step 26 : Verify product updated message displayed");
        Assert.assertEquals(shoppingCartPage.getProductUpdateMessageDisplayed(), "The total amount has been updated.");

        LogHelper.info("Shopping Cart Page -Step 27 : Verify Subtotal correctly");
        Assert.assertEquals(shoppingCartPage.isPriceActualUIDisplayed(), shoppingCartPage.isTotalExpectedDisplayed());

        LogHelper.info("Shopping Cart Page -Step 28 : Click to Plus button");
        shoppingCartPage.clickToMinusButton();

        LogHelper.info("Shopping Cart Page -Step 29 : Verify product updated message displayed");
        Assert.assertEquals(shoppingCartPage.getProductUpdateMessageDisplayed(), "The total amount has been updated.");
        sleepInSecond(3);
        LogHelper.info("Shopping Cart Page -Step 30 : Verify Subtotal correctly");
        Assert.assertEquals(shoppingCartPage.isPriceActualUIDisplayed(), shoppingCartPage.isTotalExpectedDisplayed());

        LogHelper.info("Shopping Cart Page -Step 31 : Enter discount code 'AUTOTEST3' ");
        shoppingCartPage.inputDiscountCodeToTextbox("AUTOTEST3");

        LogHelper.info("Shopping Cart Page -Step 32 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 33 : Verify message displayed");
        ...
        LogHelper.info("Shopping Cart Page -Step 34 : Enter discount code < 4 characters");
        shoppingCartPage.inputDiscountCodeToTextbox("Van");

        LogHelper.info("Shopping Cart Page -Step 35 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 36 : Verify error message displayed");
        Assert.assertEquals(shoppingCartPage.getErrorMessageDisplayed(), "Code must be 4-20 characters long.");

        LogHelper.info("Shopping Cart Page -Step 37 : Enter discount code >20 characters");
        shoppingCartPage.inputDiscountCodeToTextbox("qwertyuiopqwertyuiop1");

        LogHelper.info("Shopping Cart Page -Step 38 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 39 : Verify error message displayed");
        Assert.assertEquals(shoppingCartPage.getErrorMessageDisplayed(), "Code must be 4-20 characters long.");

        LogHelper.info("Shopping Cart Page -Step 40 : Enter discount code expired");
        shoppingCartPage.inputDiscountCodeToTextbox("TRANGFKHBP");

        LogHelper.info("Shopping Cart Page -Step 41 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 42 : Verify error message displayed");
        ...
        LogHelper.info("Shopping Cart Page -Step 43 : Enter discount code 5%");
        shoppingCartPage.inputDiscountCodeToTextbox("AUTOTEST8");
        double discountPriceShipping = shoppingCartPage.isDiscountPriceExpected();

        LogHelper.info("Shopping Cart Page -Step 44 : Click to Apply Button");
        shoppingCartPage.clickToApplyButton();

        LogHelper.info("Shopping Cart Page -Step 45 : Verify the discount price with code %");
        Assert.assertEquals(discountPriceShipping, shoppingCartPage.isDiscountPriceActual());

        LogHelper.info("Shopping Cart Page -Step 46 : Verify the total discount price with code %");
    ...
    public void TC_04_Home_Signup_Signin() {
        ...
        LogHelper.info("Home Page -Step 04 : Enter password < 8 characters ");
        ...
        LogHelper.info("Home Page -Step 06 : Verify error message displayed when enter password < 8 characters");
        ...
        LogHelper.info("Home Page -Step 07 : Enter password >16 characters ");
        homePage.inputToTextboxByID(driver, "email", email);
        ...
        LogHelper.info("Home Page -Step 09 : Verify error message displayed when enter password >16 characters");
        Assert.assertTrue(homePage.isErrorMessageAtPasswordDisplayed("Password must be 8-16 characters long."));
        Assert.assertTrue(homePage.isErrorMessageAtConfirmPasswordDisplayed("Confirm password does not match"));

        LogHelper.info("Home Page -Step 10 : Enter incorrect confirm password ");
        homePage.inputToTextboxByID(driver, "email", email);
        homePage.inputToTextboxByID(driver, "password", passwordAuto);
        ...
        LogHelper.info("Home Page -Step 12 : Verify error message displayed when enter confirm password incorrect");
        Assert.assertTrue(homePage.isErrorMessageAtConfirmPasswordDisplayed("Confirm password does not match"));

        LogHelper.info("Home Page -Step 13 : Enter correct information ");
        homePage.inputToTextboxByID(driver, "email", email);
        homePage.inputToTextboxByID(driver, "password", passwordAuto);
        homePage.inputToTextboxByID(driver, "confirm_password", passwordAuto);
        ...
        LogHelper.info("Home Page -Step 15 : Verify verification email button displayed");
        Assert.assertTrue(homePage.isVerificationEmailButtonByTextDisplayed(driver, "Resend Verification Email"));

        LogHelper.info("Home Page -Step 16 : Click Sign in link ");
        homePage.clickToSigninLink();

        LogHelper.info("Home Page -Step 17 : Verify Signin  button displayed");
        Assert.assertTrue(homePage.isVerificationEmailButtonByTextDisplayed(driver, "Sign In"));

        LogHelper.info("Home Page -Step 18 : Click Sign in button ");
        homePage.clickToSigninButton(driver, "Sign In");

        LogHelper.info("Home Page -Step 19 : Verify error message displayed when blank all fields ");
        ...
        LogHelper.info("Home Page -Step 20 : Enter invalid email ");
        homePage.inputToTextboxByID(driver, "username", "TTTT");
        homePage.inputToTextboxByID(driver, "password", passwordAuto);

        LogHelper.info("Home Page -Step 21 : Click Signin button ");
        homePage.clickToSigninButton(driver, "Sign In");

        LogHelper.info("Home Page -Step 22 : Verify error message displayed when email is invalid ");
        Assert.assertTrue(homePage.isErrorMessageAtEmailSigninDisplayed("Please enter a valid email address"));

        LogHelper.info("Home Page -Step 23 : Enter not exist email ");
        ...
        LogHelper.info("Home Page -Step 25 : Verify error message displayed when email is not exist ");
        Assert.assertTrue(homePage.isErrorMessageAtEmailSigninDisplayed("Email does not exist. "));

        LogHelper.info("Home Page -Step 26 : Enter password < 8 characters ");
        ...
        LogHelper.info("Home Page -Step 28 : Verify error message displayed when password < 8 characters ");
        Assert.assertTrue(homePage.isErrorMessageAtPasswordSigninDisplayed("Password must be 8-16 characters long."));

        LogHelper.info("Home Page -Step 29 : Enter password > 16 characters ");
        homePage.inputToTextboxByID(driver, "username", email);
        ...
        LogHelper.info("Home Page -Step 31 : Verify error message displayed when password > 16 characters ");
        Assert.assertTrue(homePage.isErrorMessageAtPasswordSigninDisplayed("Password must be 8-16 characters long."));

        LogHelper.info("Home Page -Step 32 : Enter password incorrect ");
        ...
        LogHelper.info("Home Page -Step 34 : Verify error message displayed when password is incorrect ");
       ...
       // homePage.inputToTextboxByID(driver, "password", "12345678910");
        //rebuild
        homePage.inputToTextboxByID(driver, "password", "Vanh147852a@");

        LogHelper.info("Home Page -Step 36 : Click Signin button ");
        homePage.clickToSigninButton(driver, "Sign In");

        LogHelper.info("Home Page -Step 37 : Verify Signin popup is undisplayed");
        //Assert.assertTrue(homePage.isSignInPopupUnDisplayed());

        LogHelper.info("Home Page -Step 38 : Open My Profile Page");
    ...
    public void TC_05_Account_Setting() {
        ...
        accountSettingPage.inputToEmailTextbox("anhntv@dlsinc.com");
        ...
        accountSettingPage.inputToTextboxByName(driver, "password", "Vanh147852a@");
        ...
        accountSettingPage.inputToTextboxByName(driver, "password", "Vanh147852a@");
        accountSettingPage.inputToTextboxByName(driver, "new_password", "Vanh147852a@");
        accountSettingPage.inputToTextboxByName(driver, "confirm_password", "Vanh147852a@");
